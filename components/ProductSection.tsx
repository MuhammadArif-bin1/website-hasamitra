  ...
  return (
    <section id="produk" className="py-12 lg:py-20 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header (- Produk -) */}
        <div className="w-full bg-gradient-to-r from-orange-500 via-orange-600 to-amber-500 rounded-xl py-4 shadow-sm mb-10 text-center">
            ...
            >
              ...
              <div className="p-6 bg-slate-50 border-t border-slate-100 flex justify-center">
                <button
                  ...
                  className="w-4/5 py-2.5 px-4 bg-orange-500 hover:bg-orange-600 active:scale-95 text-white font-bold text-sm rounded-md shadow-md shadow-orange-500/20 transition-all duration-200 text-center"
                >
                  {product.buttonText}
                </button>
              </div>
