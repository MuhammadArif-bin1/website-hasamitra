      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 pb-12 border-b border-slate-800">
          ...
          <div className="space-y-4">
            <Link href="/" className="inline-block bg-white px-3.5 py-2 rounded-xl shadow-md">
              <Image
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li>
                <Link href="/produk" className="hover:text-blue-400 transition-colors">
                  PRODUK
                </Link>
              </li>
              <li>
                <Link href="/informasi" className="hover:text-blue-400 transition-colors">
                  INFORMASI
                </Link>
              </li>
              <li>
            ...
            <div className="mt-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="YouTube Bank Hasamitra"
        ...
        <div className="pt-8 flex flex-col md:flex-row items-center justify-between text-xs text-slate-500 gap-4">
          ...
          <div className="flex items-center gap-6">
            ...
            <span>•</span>
            <a href={`https://wa.me/${contactData.whatsappNumber}`} target="_blank" rel="noopener noreferrer" className="hover:text-emerald-400 transition-colors">
