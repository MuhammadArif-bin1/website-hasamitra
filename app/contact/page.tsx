...
export const metadata = {
  title: "Contact Us - Bank Hasamitra Jawa Barat",
  description: "Hubungi PT BPR Hasamitra Jawa Barat via Email, Telepon, WhatsApp 085772780037, atau kunjungi kantor kami di Margonda Depok.",
};
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12 lg:mb-16">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-slate-900 tracking-tight mb-4">
              Kontak & Layanan Hasamitra
            </h1>
            <p className="text-base sm:text-lg text-slate-600 leading-relaxed">
              Tim Bank Hasamitra Jawa Barat siap melayani segala kebutuhan perbankan, pertanyaan, dan pengaduan Anda.
            </p>
          </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-sm text-blue-700 font-semibold hover:underline mt-1 inline-block"
                    >
                      {contactData.email}
                    </a>
                  </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-sm text-slate-800 font-semibold hover:text-blue-700 mt-1 inline-block"
                    >
                      {contactData.phone}
                    </a>
                  </div>
                ...
                <div className="flex items-start gap-4 pt-2 border-t border-slate-100">
                  ...
                  <div className="flex-1 space-y-3">
                    <div>
                      ...
                      <p className="text-base font-bold text-emerald-700 tracking-wide mt-0.5">
                ...
                <div className="pt-4 border-t border-slate-100">
                  ...
                  <div className="flex items-center gap-3">
                    <a
                      ...
                      className="px-4 py-2 rounded-lg bg-slate-100 hover:bg-blue-600 hover:text-white text-slate-700 font-semibold text-xs flex items-center gap-2 transition-colors"
                    >
                      Facebook
                    </a>
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="px-4 py-2 rounded-lg bg-slate-100 hover:bg-pink-600 hover:text-white text-slate-700 font-semibold text-xs flex items-center gap-2 transition-colors"
                    >
                      Instagram
                    </a>
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="px-4 py-2 rounded-lg bg-slate-100 hover:bg-red-600 hover:text-white text-slate-700 font-semibold text-xs flex items-center gap-2 transition-colors"
                    >
                      YouTube
                    </a>
                  </div>
